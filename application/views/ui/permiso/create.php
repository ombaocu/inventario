            ...
            <form class="form-floating" novalidate="novalidate" ng-submit="saveItem(item)">
                <fieldset>
                    ...
                    <div class="form-group {{filledClass}}">
                        ...
                        <input type="text" class="form-control" ng-model="item.description" required ng-disabled="!item.editing">
                    ...
                    <div class="form-group {{filledClass}}">
                        ...
                        <input type="text" class="form-control" ng-model="item.color" required ng-disabled="!item.editing">
                        <span class="help-block" style="color: red !important;" ng-if="formErrors.color">{{formErrors.color}}</span>
                    </div>
