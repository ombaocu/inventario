...
?>
            ...
            <div class="login-box-body" ng-controller="AuthController">
                ...
                <?php echo form_open('auth/login');?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                            <?php echo form_button('submit', lang('auth_login'), array('class' => 'btn btn-primary btn-block btn-flat', 'ng-click' => 'login(item);'));?>
                        </div>
                    </div>
                <?php echo form_close();?>
