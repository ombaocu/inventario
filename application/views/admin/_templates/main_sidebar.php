...
<?php endif; ?>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <!-- Sidebar main menu planificacion  -->
                        <li class="header text-uppercase"><?php echo lang('menu_main_planificacion'); ?></li>
                        <li class="<?=active_link_controller('dashboard')?>">
                            <a href="<?php echo site_url('admin/dashboard'); ?>">
                                <i class="fa fa-dashboard"></i> <span><?php echo lang('menu_item_demo'); ?></span>
                            </a>
                        </li>

                        <!-- Sidebar main menu combustibles_lubricantes  -->
                        <li class="header text-uppercase"><?php echo lang('menu_main_combustibles_lubricantes'); ?></li>
                        <li class="<?=active_link_controller('dashboard')?>">
                            <a href="<?php echo site_url('admin/dashboard'); ?>">
                                <i class="fa fa-dashboard"></i> <span><?php echo lang('menu_item_demo'); ?></span>
                            </a>
                        ...
                        <!-- Sidebar main menu vehiculos  -->
                        <li class="header text-uppercase"><?php echo lang('menu_main_vehiculos'); ?></li>
                        <li class="<?=active_link_controller('marca')?>">
                            <a href="<?php echo site_url('vehiculos/marca'); ?>">
                                <i class="fa fa-car"></i> <span><?php echo lang('menu_item_marca'); ?></span>
                            </a>
                        </li>
                        <li class="<?=active_link_controller('modelo')?>">
                            <a href="<?php echo site_url('vehiculos/modelo'); ?>">
                                <i class="fa fa-car"></i> <span><?php echo lang('menu_item_modelo'); ?></span>
                            </a>
                        </li>


                        <li class="<?=active_link_controller('vehiculo')?>">
                            <a href="<?php echo site_url('vehiculos/vehiculo'); ?>">
                                <i class="fa fa-car"></i> <span><?php echo lang('menu_item_vehiculo'); ?></span>
                            </a>
                        </li>



                        <!-- Sidebar main menu personal  -->
                        <li class="header text-uppercase"><?php echo lang('menu_main_personal'); ?></li>
                        <li class="<?=active_link_controller('dashboard')?>">
                            <a href="<?php echo site_url('admin/dashboard'); ?>">
                                <i class="fa fa-dashboard"></i> <span><?php echo lang('menu_item_demo'); ?></span>
                            </a>
