...
<?php if ($admin_prefs['notifications_menu'] == TRUE): ?>
                            ...
                            <li class="dropdown notifications-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <span class="label label-warning"><?php  print $notification_count; ?></span>
                                </a>
                                <ul class="dropdown-menu">
                                    <li class="header"><?php echo sprintf('%s %s %s', lang('header_you_have'), $notification_count, lang('header_notification') ) ; ?> </li>
                                    <li>
                                        <ul class="menu">
                                            <?php foreach ($notifications as $notification): ?>
                                            <li><!-- start notification -->
                                                <a href="#"><i class="fa <?php echo $notification['fa_icon']; ?> text-aqua"></i> <?php echo $notification['text']; ?></a>
                                            </li><!-- end notification -->
                                            <?php endforeach; ?>
                                        </ul>
                                    </li>
