...
<?php endif; ?>
        ...
        <!--        Style for APP -->
        <link rel="stylesheet" href="<?php echo base_url('/assets/app/style.css'); ?>">


<!--        Style for FullCallendar -->
        <link rel="stylesheet" href="<?php echo base_url($plugins_dir . '/fullcalendar/fullcalendar.min.css'); ?>">
        <link rel="stylesheet" href="<?php echo base_url($plugins_dir . '/fullcalendar/fullcalendar.print.css'); ?>" media="print">
