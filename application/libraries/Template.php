...
class Template {
    ...
    public function index_render($content, $data = NULL)
    {
        if ( ! $content)
        {
            return NULL;
...
//            $this->template['control_sidebar'] = $this->CI->load->view('public/_templates/control_sidebar', $data, TRUE);
    ...
    public function content_render($content, $data = NULL)
    {
        if ( ! $content)
        {
            return NULL;
        ...
        else
        {
            ...
            return $this->CI->load->view('ui/_templates/template', $this->template);
        }
    }
